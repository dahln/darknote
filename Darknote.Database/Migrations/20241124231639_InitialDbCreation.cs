        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListEnabled = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoteAuthorizedUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NoteAuthorizedUsers_Notes_NoteId",
                        column: x => x.NoteId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NoteListItems_Notes_NoteId",
                        column: x => x.NoteId,
                        principalTable: "Notes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteAuthorizedUsers_NoteId",
                table: "NoteAuthorizedUsers",
                column: "NoteId");

            migrationBuilder.CreateIndex(
                name: "IX_NoteListItems_NoteId",
                table: "NoteListItems",
                column: "NoteId");
        }
